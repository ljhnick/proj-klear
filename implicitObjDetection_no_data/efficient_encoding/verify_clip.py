...
if __name__=='__main__':
    ...
    data_path = "/users/aren10/implicitObjDetection/room_nerf/logs/seg_all_clip/renderonly_path_013999/"
    root_path = "/users/aren10/implicitObjDetection/room_nerf/logs/seg_all_clip/renderonly_path_013999/"
    ...
    for filename in directories:
        ...
        # if True:
            ...
            save_query("iron tripod", image_clip_feature_normalized)
