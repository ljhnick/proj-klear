...
def raw2outputs(raw, z_vals, rays_d, raw_noise_std=0, white_bkgd=False, pytest=False, outputClip = False, infer = False, raw_rgb = None):
    ...
    if infer:
        ...
        feature_mic = np.load("/users/aren10/data/datasets/seg_all_2DCLIP_gt/mic/features/feature_mic.npy")
        feature_wires = np.load("/users/aren10/data/datasets/seg_all_2DCLIP_gt/mic/features/feature_wires.npy")
        feature_stand = np.load("/users/aren10/data/datasets/seg_all_2DCLIP_gt/mic/features/feature_stand.npy")
